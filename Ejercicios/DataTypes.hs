--- TYPECLASS SHOW IS TO PRINT THE DATATYPE
...
--- GET MONTH WITH THIS WAY
--- let f = {day = 5, month = 'September', year = 2017}			*Note: Order doesnt matter
--- month f

--- USE TYPECLASS READ
--- let x = read "Fecha{day=5,month=\"September\",year=2017}"::Fecha		*Note: Order matters
